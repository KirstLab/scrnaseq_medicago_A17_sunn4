...
generate_dotplots_by_time <- function(file_name = file_name,
    ...
    for( i in unique(markers$Group) ) {
        ...
        ggsave(filename = paste0("images/dotplots_by_time/",folder_n,"/",
                                 ...
                                 i, ".svg"),
               plot = dotp,
               height = round(3 + round(3 + nrow(markers2)*0.5)),
...
generate_dotplots <- function(file_name = file_name,
    ...
    cds@meta.data$clusters <- cds@meta.data$seurat_clusters
...
generate_dotplots_by_time(file_name = "RECLUSTERING/PERICYCLE_v2/rds_file_subset/seurat_formated_pericycle",
                          c_nickname = "PE",
                          output_name = "seurat_formated_pericycle",
                          folder_n = "pericycle_C16_vs_Stele_Schiessl")

generate_dotplots(file_name = "RECLUSTERING/PERICYCLE_v2/rds_file_subset/seurat_formated_pericycle",
                  c_nickname = "PE",
                  output_name = "seurat_formated_pericycle",
                  folder_n = "pericycle_C16_vs_Stele_Schiessl")

generate_heatmaps_by_time(file_name = "RECLUSTERING/PERICYCLE_v2/rds_file_subset/medicago_integrated_subset_pericycle",
                          c_nickname = "PE",
                          output_name = "seurat_formated_pericycle",
                          folder_n = "pericycle_C16_vs_Stele_Schiessl")
...
generate_dotplots_by_time(file_name = "RECLUSTERING/PERICYCLE_v2/rds_file_subset/seurat_formated_pericycle",
                          c_nickname = "C",
                          output_name = "seurat_formated_pericycle",
                          folder_n = "pericycle_C16_vs_Stele_Roy")
...
#### DEGS
markers <- suppressMessages(
    vroom("all_DEGs_C16_vs_Stele_using_Seurat.tsv",
          delim = "\t",
          col_names = T,
          na = "NA") )
...
generate_dotplots_by_time(file_name = "RECLUSTERING/PERICYCLE_v2/rds_file_subset/seurat_formated_pericycle",
                          c_nickname = "C",
                          output_name = "seurat_formated_pericycle",
                          folder_n = "DEGS_pericycle_Schiessl")
