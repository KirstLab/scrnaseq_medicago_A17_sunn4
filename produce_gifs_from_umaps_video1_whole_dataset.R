...
outfile <- "logs/produce_gifs_from_umaps_video1_whole_dataset.out" # File name of output log
#Check its existence
...
folder_name = "medicago_GIFs/VIDEO1/"
...
image_write(image = img_animated,
            path = paste0(folder_name, "Pereira_el_al_2023_video1.GIF") )
