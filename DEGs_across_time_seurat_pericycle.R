...
outfile <- "logs/DEGs_across_timepoints_reclustering_pericycle.out" # File name of output log
#Check its existence
...
require(Seurat)
require(tidyverse)
seurat_obj <- readRDS("RECLUSTERING/PERICYCLE/rds_file_subset/seurat_formated_pericycle.rds")
...
write.table(all_degs,
            "all_DEGs_pericycle_among_timepoints_using_Seurat.tsv",
            col.names = T,
            row.names = F,
            quote = T,
            sep = ",")
