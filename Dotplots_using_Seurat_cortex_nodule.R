...
generate_dotplots(file_name = "RECLUSTERING/CORTEX_NOD/rds_file_subset/seurat_formated_cortex_nod_selected_clusters_RECLUSTERED",
                  c_nickname = "CN",
                  output_name = "seurat_formated_cortex_nod",
                  folder_n = "cortex_nod_Schiessl")

generate_heatmaps(file_name = "RECLUSTERING/CORTEX_NOD/rds_file_subset/cortex_nod_selected_clusters_RECLUSTERED",
                  c_nickname = "CN",
                  output_name = "seurat_formated_cortex_nod",
                  folder_n = "cortex_nod_Schiessl")

generate_dotplots_by_time(file_name = "RECLUSTERING/CORTEX_NOD/rds_file_subset/seurat_formated_selected_clusters_cortex_nodule",
                          c_nickname = "CN",
                          output_name = "seurat_formated_cortex_nod",
                          folder_n = "cortex_nod_Schiessl_by_time")

generate_heatmaps_by_time(file_name = "RECLUSTERING/CORTEX_NOD/rds_file_subset/cortex_nod_selected_clusters_RECLUSTERED",
                          c_nickname = "CN",
                          output_name = "seurat_formated_cortex_nod",
                          folder_n = "cortex_nod_Schiessl_by_time")
...
generate_dotplots(file_name = "RECLUSTERING/CORTEX_NOD/rds_file_subset/seurat_formated_selected_clusters_cortex_nodule",
                  c_nickname = "CN",
                  output_name = "seurat_formated_cortex_nod",
                  folder_n = "cortex_nod_Roy")
...
generate_dotplots_by_time(file_name = "RECLUSTERING/CORTEX_NOD/rds_file_subset/seurat_formated_selected_clusters_cortex_nodule",
                          c_nickname = "CN",
                          output_name = "seurat_formated_cortex_nod",
                          folder_n = "cortex_nod_Roy_by_time")
